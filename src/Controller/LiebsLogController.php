...
use Drupal\liebs_log\LiebsLogReader;
 ...
 /**
  ...
  public static function create(ContainerInterface $container): self {
    return new self(
          ...
          $container->get('liebs_log.middleware'),
      );
  }
  ...
  public function ridelog(): array {
    $response = $this->reader->readLog();
    $rides    = $this->parse($response->data);

    return [
      '#type' => 'component',
      '#component' => 'liebs_log:ridelog',
      '#props' => ['rides' => $rides],
    ];
  }
